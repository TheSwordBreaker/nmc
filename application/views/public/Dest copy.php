...
<div class="site-blocks-cover overlay inner-page-cover" style="background-image: url(<?= base_url('assets/images/despage/') . $sec3[0]->img ?>); background-attachment: fixed;">
    <div class="container">
                    ...
                    <?php for ($i = 0; $i < 6; $i++) : ?>
                        <div class="col-md-4 ml-auto mr-auto ">
                            <a href="#" target="_blank">
                                <!--Image simple-->
                                <img src="<?= base_url('./assets/images/despage/muesum/') . $sec5[$i]->img ?>" class="img-raised  img-fluid img-responsive">
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="3000">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100 h-100" style="height:fit-content" src="<?= base_url('assets/images/despage/mountain/') . $sec6[0]->img ?>" alt="First slide">
                                    ...
                                    <?php for ($i = 1; $i < 5; $i++) : ?>
                                        <div class="carousel-item">
                                            <img class="d-block w-100 h-100" style="height:fit-content" src="<?= base_url('assets/images/despage/mountain/') . $sec6[$i]->img ?>" alt="Second slide">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h4>
                            ...
                            <div class="col-md-4 ml-auto mr-auto">
                                <div class="team-player">
                                    <div class="card card-plain px-3">
                                        ...
                                        <img src="<?= base_url('assets/images/despage/waterfall/') . $sec7[$i]->img ?>" alt="img-responsive" class="img-resized img-responsive">
