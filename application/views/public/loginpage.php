...
<body class="login-page sidebar-collapse">
  ...
  <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
    <div class="container">
      ...
      <div class="navbar-translate">
        <a class="navbar-brand" href="<?= base_url('MainC/')?>" rel="tooltip" title="Designed by Invision. Coded by Creative Tim" data-placement="bottom" target="_blank"><i class="fa fa-plane" aria-hidden="true"></i>
           Nashik Tourism
        </a>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="../assets/images/blurred-image-1.jpg" style="font-size: 1.20571em; letter-spacing: 1px;">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('MainC/AboutUs')?>">About Us</a>
          </li>
          <li class="nav-item">
  ...
  <div class="page-header clear-filter" filter-color="">
    <div class="page-header-image" style="background-image:url(<?= base_url('/assets/images/KumbhMela.jpg')?>)"></div>
    <div class="content">
      <div class="container">
          ...
          <div class="card card-login card-plain">
            ...
            <!-- <form class="form" method="post" action="<?= base_url('/WorkC/AuthUser')?>"> -->
              ...
              <div class="card-body">
                ...
                <?php echo form_error('username','<div class="p-1.5 bg-danger text-white">', '</div>');?>
                <div class="input-group no-border input-lg">
                  <div class="input-group-prepend">
                    <span class="input-group-text">
                ...
                <?php echo form_error('password','<div class="p-1.5 bg-danger text-white">', '</div>');?>
              </div>
