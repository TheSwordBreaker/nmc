...
<div class="site-section">
    <div class="container">
        ...
        <div class="button">
            <div class="text-center">
                <!-- <a href="#" class="btn btn-primary  py-3 px-5 " style="background-color: #f70255;" >View All Events</a> -->
                <a href="s<?= base_url('MainC/all/destsec2')?>" class="btn btn-primary"
                    style="background-color: #f70255;">View All Events</a>
            </div>
...
<div class="site-blocks-cover overlay inner-page-cover"
    style="background-image: url(<?= base_url('assets/images/despage/').$sec3[0]->img ?>); background-attachment: fixed;">
    <div class="container">
        <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-7" data-aos="fade-up" data-aos-delay="400">
                <a href="<?= base_url('assets/video/').$sec3[0]->video ?>"
    ...
    <div class="container-fluid text-center">
        <div class="row">
            <div class="col-md-8 ml-auto mr-auto text-center">
                ...
                <h4>This websites is sponsored by NMC ( Nashik Municipal Corporation ) website which can also help you
                    for your official work...!!! and this site also provides more information about Nashik city...!!!
                </h4>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 ml-auto mr-auto ">
                        <a href="#" target="_blank">
                            <!--Image simple-->
                            <img src="<?= base_url('./assets/images/').$sec5[$i]->img ?>"
                                class="img-raised  img-fluid img-responsive">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100 h-100" style="height:fit-content"
                                            src="<?= base_url('assets/images/').$sec6[0]->img ?>"
                                            alt="First slide">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100 h-100" style="height:fit-content"
                                            src="<?= base_url('assets/images/').$sec6[$i]->img ?>"
                                            alt="Second slide">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h4>
...
<div class="section">
    <div class="container-fluid text-center">
        <div class="row">
            ...
            <div class="section sextion-examples">
                <div class="team pt-3">
                    <div class="row">
                        <?php for ($i=0; $i < 3 ; $i++): ?>
                        <div class="col-md-4 ml-auto mr-auto">
                            <div class="team-player">
                                <div class="card card-plain px-3">
                                    ...
                                    <img src="<?= base_url('assets/images/').$sec7[$i]->img ?>"
                                        alt="img-responsive" class="img-resized img-responsive">
                                    <h4 class="card-title" style="font-family: verdana; font-size: 15px;">
                                        <?= $sec7[$i]->name ?>
                                        <br>
        ...
        <div class="button">
            <div class="text-center">
                <!-- <a href="#" class="btn btn-primary  py-3 px-5 " style="background-color: #f70255;" >View All Events</a> -->
                <a href="<?= base_url('MainC/all/destsec7')?>" class="btn btn-primary"
                    style="background-color: #f70255;">View All Events</a>
            </div>
        </div>
    </div>
