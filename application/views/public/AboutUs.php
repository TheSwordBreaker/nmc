...
<body class="index-page sidebar-collapse">
  ...
  <div class="page-header header-filter " data-parallax="true" style="background-image: url(<?= base_url('assets/images/PRIMG3.jpg') ?>);">
    <div class="container">
      <div class="row">
    ...
    <div class="section">
      ...
      <div class="col-md-8 ml-auto mr-auto " style="font-size: 40px;">
         <h3 style="font-family: verdana;">About Nashik</h3>
            ...
            <p style="font-family: verdana;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nashik is developing as a lively city with a blend of the ancient and the modern touches. The city has numerous forts, temples, historic sites as well as a home for industries. Nashik is also popular for fruit and vegetable productions. Grapes, strawberries and onions are amongst the highest in the country.</p>
            <p style="font-family: verdana;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tourists can also organize trips to Shirdi, Trimbakeshwar, Dudhasagar Waterfalls, Saptashringi Devi Temple, Nandurmadhmeshwar, Bhandardara Jawhar and Nandur Madhameshwar Bird Sanctuary, which are not so far the city.</p>
            <p style="font-family: verdana;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Reaching Nashik too is so easy as the Nashik railway station is one of the major stations of the Central Railway. Nashik is 220 km away from Pune. Nearest airport is Mumbai or Pune with a distance of 175 km.</p>
            <h3 style="font-family: verdana;">History Of Nashik</h3>
            <p style="font-family: verdana;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nashik was included also under Ashok's mighty empire. Later, Nashik district became very prosperous during the era of the Satavahana as it lay on the trade route to Broach (Gujarat). During Mughal period, the city was named as Gulshanabad appreciating its beauty. The old name was restored when Peshwas took over in 1751. By 1818, Nashik became an important town with two palaces, magnificent buildings and beautiful gardens and vineyards. Nashik surrendered to the British on April 19,1818. Nashik too was in great disturbance during the freedom struggle of 1857. But it retained its peace after the struggle ended in 1860.</p>
          </br>
           <h4 style="font-family: verdana;"><b> Milestones in the history of Nashik</b><h4>
           <p style="font-size: 16px;">Some of the major events in the history of Nashik are 
           <li style="font-size: 14px;">1840   :   Sarvajanik Vachanalaya established. (Public Library) </li>
           ...
           <li style="font-size: 14px;">1894   :   Construction work for Victoria Bridge started. </li> 
          ...
          <h4 style="font-family: verdana;"><b>Brief about Nashik</b></h4>
...
<br>
<h4 style="font-family: verdana;"><b> Villages in Nashik</b></h4>
<h3 style="font-family: verdana;">&nbsp;&nbsp;&nbsp;Tahsil-wise list of census villages in Nashik district, Maharashtra, India</h3>
<table class="table table-hover table-bordered table-small">

<thread style="font-size:14px;">
<tr>
<th style= "font-size:20px;">Sr. No.</th>
<th style= "font-size:20px;">Name of Tahsils</th>  
<th style= "font-size:20px;">Total Villages</th>
</tr>
</thread>
<tbody>
<tr><td style= "font-size:18px;">1</td> 
<td style= "font-size:18px;">Baglan</td> 
<td style= "font-size:18px;">171</td>
</tr>
<tr><td style= "font-size:18px;">2</td> 
<td style= "font-size:18px;">Chandvad</td>
<td style= "font-size:18px;">112</td>
</tr>
<tr><td style= "font-size:18px;">3</td> 
<td style= "font-size:18px;">Deola </td>
<td style= "font-size:18px;">50</td>
</tr>
<tr><td style= "font-size:18px;">4</td> 
<td style= "font-size:18px;">Dindori</td>
<td style= "font-size:18px;">112</td>
</tr>
<tr><td style= "font-size:18px;">5</td> 
<td style= "font-size:18px;">Igatpuri</td>
<td style= "font-size:18px;">158</td>
</tr>
<tr><td style= "font-size:18px;">6</td> 
<td style= "font-size:18px;">Kalwan</td>
<td style= "font-size:18px;">152</td>
</tr>
<tr><td style= "font-size:18px;">7</td> 
<td style= "font-size:18px;">Malegaon</td>
<td style= "font-size:18px;">150</td>
</tr>
<tr><td style= "font-size:18px;">8</td> 
<td style= "font-size:18px;">Nandgaon</td>
<td style= "font-size:18px;">102</td>
</tr>
<tr><td style= "font-size:18px;">9</td> 
<td style= "font-size:18px;">Nashik</td>
<td style= "font-size:18px;">80</td>
</tr>
<tr><td style= "font-size:18px;">10</td> 
<td style= "font-size:18px;">Niphad</td>
<td style= "font-size:18px;">137</td>
</tr>
<tr><td style= "font-size:18px;">11</td> 
<td style= "font-size:18px;">Peint</td>
<td style= "font-size:18px;">145</td>
</tr>
<tr><td style= "font-size:18px;">12</td> 
<td style= "font-size:18px;">Sinnar</td>
<td style= "font-size:18px;">131</td>
</tr>
<tr><td style= "font-size:18px;">13</td> 
<td style= "font-size:18px;">Surgana</td>
<td style= "font-size:18px;">191</td>
</tr>
<tr><td style= "font-size:18px;">14</td> 
<td style= "font-size:18px;">Trimbakeshwar</td>
<td style= "font-size:18px;">126</td>
</tr>
<tr>
<tr><td style= "font-size:18px;">15</td> 
<td style= "font-size:18px;">Yeola</td>
<td style= "font-size:18px;">125</td>
</tr>
</table>
      ...
      <div class="container text-center">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            <h2 style="font-family: verdana;">Climate in Nashik</h2>
            <h4 style="font-family: verdana;">Graph</h4>
  ...
  <div class="section">
    ...
    <div class="section">
      <div class="container text-center">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            <h2 style="font-family: verdana;">Visit Our Sponsors Websites!!!</h2>
            <h4 style="font-family: verdana;">This websites is sponsored by NMC ( Nashik Municipal Corporation ) website which can also help you for your official work...!!! and this site also provides more information about Nashik city...!!!</h4>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <a href="https://nashikcorporation.in/" target="_blank">
              <img src="<?= base_url('./assets/images/NMC1.png')?>" alt="Rounded Image" class="img-raised rounded img-fluid">
          ...
          <div class="col-md-6">
            <a href="https://nashikcorporation.in/article/index/id/1#tabs|History:tab1" target="_blank">
              <img src="<?= base_url('./assets/images/NMC2.png')?>" alt="Rounded Image" class="img-raised rounded img-fluid">
