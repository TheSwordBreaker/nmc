    ...
    <div class="section">
      ...
      <div class="col-md-10 ml-auto mr-auto ">
        ...
        <thead style="text-align: center;">
          <tr>
            <th>Sr. No.</th>
            <th>Name of Tahsils</th>
            <th>Total Villages</th>
          </tr>
        </thead>
        <tbody style="font-family: verdana; font-size: 15px; text-align: center;">
          <tr><td>1</td> 
          <td>Baglan</td> 
          <td>171</td>
          </tr>
      ...
      <div class="col-md-10 ml-auto mr-auto ">
        ...
        <p>
            ...
            It is the home town of several prominent personalities like Veer Savarkar (freedom fighter), Anant Kanhere (freedom fighter), Kusumagraj Shirvadkar (poet) and Dadasaheb Phalake (movie maker). The city, located 180kms from Mumbai and 220 km from Pune, is also renowned for the world famous fair named Maha Kumbh Mela, held once in every 12 years.
        </p>
      </div>
      </div>
      <div class="section">
              ...
              <div class="container-fluid text-center">
                <div class="row">
                  <div class="col-md-5 ml-auto mr-auto ">
                    <a href="https://nashikcorporation.in/" target="_blank"><!--Image simple-->
                      <img src="<?= base_url('./assets/images/NMC1.png')?>" class="img-raised  img-fluid">
                  ...
                  <div class="col-md-5 ml-auto mr-auto ">
                    <a href="https://nashikcorporation.in/article/index/id/1#tabs|History:tab1" target="_blank">
                      <img src="<?= base_url('./assets/images/NMC2.png')?>" class="img-raised rounded img-fluid">
