...
<html lang="en">
    ...
    <body class="index-page sidebar-collapse">
        ...
        <div class="page-header header-filter clear-filter" data-parallax="true"
            style="background-image: url(<?= base_url('assets/images/dham.jpg') ?>);">
            <div class="container">
                <div class="row">
                    ...
                    <div class="row align-items-stretch">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                            <a href="#" class="unit-1 text-center">
                                <img src="<?= base_url('assets/images/').$data[$i]->img ?>" alt="Image"
                                    class="img-fluid">
            ...
            <div class="site-section">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                            <a href="#" class="unit-1 text-center">
                                <img src="<?= base_url('assets/images/pandavlene.jpg') ?>" alt="Image"
                                    class="img-fluid">
                                <div class="unit-1-text">
                                    <strong class="text-primary mb-2 d-block"></strong>
