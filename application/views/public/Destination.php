<?php require('Header2.php') ?>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            ...
            <div class="unit-4 d-flex">
              <div><br>
                <h3><?= $data[$i]->name ?></h3>
                <p><?= $data[$i]->des ?></p>
                <p><a href="<?= base_url('MainC/DestPlace');?>">Learn More</a></p>
              </div>
            </div>
          </div>
  ...
  <div class="site-section">
    ...
    <div class="site-blocks-cover overlay inner-page-cover" style="background-image: url(<?= base_url('assets/images/2.jpg') ?>); background-attachment: fixed;">
      <div class="container">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="unit-4 d-flex">
             <!--div class="unit-4-icon mr-4"><span class="text-primary flaticon-ship"></span></div>-->
              <div>
                <h3><b>Day 2</b></h3>
                <p style="font-size: 17px;">The next day should be earmarked for a visit to the glorious
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="unit-4 d-flex">
             <!-- <div class="unit-4-icon mr-4"><span class="text-primary flaticon-route"></span></div>-->
              <div>
                <h3><b>Day 3</b></h3>
                <p style="font-size: 17px;">The third day can start with blessings from the holy site of
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="unit-4 d-flex">
             <!-- <div class="unit-4-icon mr-4"><span class="text-primary flaticon-sailboat"></span></div>-->
              <div>
                <h3><b>Day 5</b></h3>
                <p style="font-size: 17px;">The fifth day can be start with Dhudsagar falls offer a panoramic view with a spectacular scenery, which may also include Balaji temple in this visit. There is another best place to visit that is Navsha Ganpati Temple of Lord Ganesha. These places are closer from one another. </p>
                <p><a href="#">Learn More</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="unit-4 d-flex">
             <!-- <div class="unit-4-icon mr-4"><span class="text-primary flaticon-ski"></span></div>-->
              <div>
                <h3><b>Day 6</b></h3>
                <p style="font-size: 17px;">Then the next day you can go to Saptashrungi Gad, a hill range situated 60 km from Nashik and forms a part of the Sahyadri range.Then you can go for Saputara, snuggled in the Sahyadris or the Western Ghats, a quaint little hill station near to Nashik.</p>
                </br><p><a href="#">Learn More</a></p>
              </div>
            </div>
          </div>
  ...
  <script src="<?= base_url('/assets/js2/plugins/moment.min.js') ?>"></script>
  <!--  Plugin for the Datepicker, full documentation here: https://github.com/Eonasdan/bootstrap-datetimepicker -->
  <script src="<?= base_url('/assets/js2/plugins/bootstrap-datetimepicker.js') ?>" type="text/javascript"></script>
