...
<section class="welcome py-5">
  ...
  <h4 class="color-black-opacity-5">Experience Our Outstanding Nashik....</h4>
<!--  carousel  -->
                ...
                <div class="card card-raised card-carousel">
                    ...
                    <div class="carousel-item"><br><br><br>
                            ...
                            <div class="row welcome-grids">
			                    ...
			                    <div class="col-lg-6 mt-lg-0 mt-5 welcome-grid3">
				                    <div class="position" style="margin-right:15px;" >
					                  <img src="<?= base_url('assets\images\culture\music&sport\guava4.jpg') ?>" alt="" class="img-fluid" />
				                    </div>
			                    </div>
                        </div>        
                            </div>
