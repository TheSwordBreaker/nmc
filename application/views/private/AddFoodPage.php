      ...
      <div class="col-md-8">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">Edit FoodStuff Page</h5>
              </div>
              <div class="card-body">
              <?php if(!$up):?>
                <?php echo form_open_multipart('UserC/AddFoodpage');?>  
                  ...
                  <?php else: ?>
                  <?= form_open_multipart('UserC/editFoodpage/'.$UserData[0]->id);?>   
                  ...
                  <div class="col-md-12">
                  <img src="<?= base_url('/assets/images/foodpage/').$UserData[0]->img ?>"  width="200"> 
                  </div>
